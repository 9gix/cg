...
void BVH::quaternionMoveJoint(JOINT* joint, float* mdata, float scale)
{
    ...
    {        		
		...
		switch(channel->type){
		case X_POSITION:
			joint->transform.translation = glm::vec3(joint->transform.translation.x + (value * scale), joint->transform.translation.y, joint->transform.translation.z);
			break;

		case Y_POSITION:
			joint->transform.translation = glm::vec3(joint->transform.translation.x, joint->transform.translation.y + (value * scale), joint->transform.translation.z);
			break;

		case Z_POSITION:
			joint->transform.translation = glm::vec3(joint->transform.translation.x, joint->transform.translation.y, joint->transform.translation.z + (value * scale));
			break;
